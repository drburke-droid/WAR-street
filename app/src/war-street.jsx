...
if (cur === null && !guest) {
  ...
  return (
    <div style={{background:"#1a1a1a",height:"100dvh",display:"flex",alignItems:"center",justifyContent:"center",padding:0,overflow:"hidden",maxWidth:"100vw",touchAction:"none",position:"fixed",inset:0}}>
      ...
      <div style={{position:"relative",width:"min(120vw, calc(100dvh * 768 / 1376 / 1.15))",height:"min(100dvh, calc(120vw * 1376 * 1.15 / 768))",touchAction:"none"}}>
        ...
        <div style={{position:"absolute",inset:0,pointerEvents:"none",zIndex:2,overflow:"hidden"}}>
          <div style={{position:"absolute",top:0,left:0,right:0,height:"17.39%",backgroundImage:"url(/WAR-street/palm-frame.png)",backgroundSize:"100% auto",backgroundPosition:"top center",backgroundRepeat:"no-repeat"}}/>
          <div style={{position:"absolute",top:"17.39%",left:0,right:0,height:"65.22%",backgroundImage:"url(/WAR-street/palm-frame.png)",backgroundSize:"100% 166.67%",backgroundPosition:"0% 50%",backgroundRepeat:"no-repeat"}}/>
          <div style={{position:"absolute",bottom:0,left:0,right:0,height:"17.39%",backgroundImage:"url(/WAR-street/palm-frame.png)",backgroundSize:"100% auto",backgroundPosition:"bottom center",backgroundRepeat:"no-repeat"}}/>
        </div>
      </div>
    </div>
  );
...
return (
  <div style={{background:"#1a1a1a",height:"100dvh",display:"flex",alignItems:"center",justifyContent:"center",padding:0,overflow:"hidden",maxWidth:"100vw",touchAction:"none",position:"fixed",inset:0}}>
    ...
    <div style={{
      position:"relative",
      width: "min(120vw, calc(100dvh * 768 / 1376 / 1.15))",
      height: "min(100dvh, calc(120vw * 1376 * 1.15 / 768))",
      touchAction:"none",
    }}>
      ...
      {(()=>{
        const DBG = false;
        const bst = (left,top,w,h,color) => ({position:"absolute",left,top,width:w,height:h,zIndex:3,cursor:"pointer",borderRadius:h==="6.6%"||h==="6.4%"||h==="6.1%"||h==="6.2%"?"50%":"40%",
        ...
        return <>
          <div onClick={openPaper} style={bst("5.5%","86.9%","14.8%","6.4%","rgba(255,0,0,0.7)")} title="Box Scores"/>
          <div onClick={()=>setVw("PORT")} style={bst("25.8%","86.7%","14.8%","6.6%","rgba(0,180,0,0.7)")} title="Portfolio"/>
          <div onClick={()=>scrollBy(-1)} style={bst("44.5%","87.5%","14.1%","2.9%","rgba(0,100,255,0.7)")} title="Scroll Up"/>
          <div onClick={()=>scrollBy(1)} style={bst("44.5%","93.0%","13.8%","1.3%","rgba(0,200,200,0.7)")} title="Scroll Down"/>
          <div onClick={()=>setVw("MKT")} style={bst("64.1%","87.1%","14.3%","6.1%","rgba(255,140,0,0.7)")} title="Market"/>
          <div onClick={()=>setMenu(m=>!m)} style={bst("84.6%","87.0%","10.2%","6.2%","rgba(160,0,220,0.7)")} title="Settings"/>
        </>;
      })()}
    </div>
